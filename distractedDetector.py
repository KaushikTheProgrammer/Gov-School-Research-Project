#  RUN WITH: python distractedDetector.py --shape-predictor shape_predictor_68_face_landmarks.dat
...
array_size=1000     #average calculated over last X array values
preR=False 
postR=False 
...
while True:
    ...
    ########################################
        ...
        if len(LIST) < array_size :  #modify array_size to take average of last 5400 frames = 3 mins required
            ...
            cv2.putText(frame, "PERCLOS: " + str(AVG_XFrames), (250, 300),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
